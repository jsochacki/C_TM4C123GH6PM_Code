...
extern void MaximizeMOD(double ratio, unsigned long* nFRAC, unsigned long* nMOD);
extern void MinimizeMOD(double ratio, unsigned long* nFRAC, unsigned long* nMOD);
extern void DetermineFeedbackValues(double output_freq, double reference_freq, unsigned short* nINT, unsigned long* nFRAC, unsigned long* nMOD);
